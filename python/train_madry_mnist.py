...
def test_model(model, attack=lambda x, *args: (x.permute(0,2,3,1), None, None)):
    ...
    for data, target in test_loader:
        ...
        output = model(Normalize((0.1307,), (0.3081,))(data))
...
madry_natural = MadryNet()
madry_natural.cuda()
madry_natural.load_state_dict(torch.load('madry_natural1.pth'))

pytex_natural = PytorchExampleNet()
pytex_natural.cuda()
pytex_natural.load_state_dict(torch.load('pt-ex1.pth'))
