...
dataset = Dataset('/home/aleksey/code/nips2017-nw/dataset/images/', transform=tf)
...
for cfg, model in zip(cfgs, ensemble.models):
    checkpoint_path = os.path.join('/home/aleksey/code/nips2017-nw/shared/checkpoints/',cfg['checkpoint_file'])
